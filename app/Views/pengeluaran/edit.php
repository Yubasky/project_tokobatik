...
<div class="page-title">
    <div><h4><i class="bi bi-arrow-up-circle-fill me-2 text-warning"></i><?= esc($title) ?></h4></div>
    <a href="<?= base_url($role . '/pengeluaran') ?>" class="btn btn-outline-secondary"><i class="bi bi-arrow-left me-1"></i> Kembali</a>
</div>
<div class="row justify-content-center"><div class="col-md-7">
<div class="card">
<div class="card-header"><i class="bi bi-pencil-square me-2"></i>Edit Pengeluaran</div>
<div class="card-body">
<form action="<?= base_url($role . '/pengeluaran/update/' . $pengeluaran['id_pengeluaran']) ?>" method="POST"><?= csrf_field() ?>
<div class="row g-3">
    <div class="col-md-6">
    ...
    <div class="col-md-6">
        ...
        <select name="kategori" class="form-select">
            ...
            <option value="<?= $k ?>" <?= old('kategori', $pengeluaran['kategori']) === $k ? 'selected' : '' ?>><?= $k ?></option>
            <?php endforeach; ?>
        </select>
    </div>
    <div class="col-12">
    ...
    <div class="col-12">
        ...
        <div class="input-group">
            ...
            <input type="number" name="jumlah" class="form-control" value="<?= old('jumlah', $pengeluaran['jumlah']) ?>" min="1" required>
        </div>
    </div>
</div>
