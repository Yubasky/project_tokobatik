...
class PemasukanModel extends Model
{
    ...
    /**
     * Override insert: otomatis catat ke tbl_kas dengan jumlah positif
     */
    ...
    /**
     * Update pemasukan dan update entri kas terkait
     */
    public function updateWithKas(int $id, array $data): bool
    {
        ...
        $kasModel = new TblKasModel();
        $kasModel->where('noref', 'IN-' . $id)->set([
            'tanggal'    => $data['tanggal'],
            'keterangan' => $data['keterangan'],
            'jumlah'     => abs($data['jumlah']),
        ])->update();
    ...
    /**
     * Delete pemasukan dan hapus entri kas terkait
     */
    public function deleteWithKas(int $id): bool
    {
        ...
        $kasModel = new TblKasModel();
        $kasModel->where('noref', 'IN-' . $id)->delete();
